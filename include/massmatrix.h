...
//
void massmatrix(
  const Eigen::MatrixXd & l,  // per ogni faccia mi dice lunghezza degli half-edge
  const Eigen::MatrixXi & F,  // per ogni faccia contiene indici vertici che la compongono
